...
//        http.cors().disable().antMatcher("/api/auth/**");
        http.authorizeRequests().antMatchers("/Auth/**","/notifications/**","/follow/**","/book/**","/swagger-ui.html").permitAll();
//        http.authorizeRequests().antMatchers("/auteur/**").hasAuthority("AUTEUR");
